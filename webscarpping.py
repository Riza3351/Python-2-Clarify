        ...
        try:
            ...
            if link: 
                ...
                if filme_resposta.status_code == 200: 
                    filmes_soup = BeautifulSoup(filme_resposta.text, "html.parser")


                    diretor_tag = filmes_soup.find("div", class_="meta-body-item meta-body-direction meta-body-oneline")
                    ...
                    # capturar os generos 
                    genero_block = filmes_soup.find('div', class_='meta-body-info')
            ...
            # dica a tag span e nome da classe é date 
            ...
            print(f"Erro ao processar o fime {titulo}. Erro: {erro}") 
